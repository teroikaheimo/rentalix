    ...
    render() {
        return (
                <tr>
                    ...
                    <ItemTableRowMenu admin={this.props.admin} onItemChangeRemote={this.props.onItemChangeRemote} toggleModalRemote={this.props.toggleModalRemote} id={this.props.rowData.serial}/>
                </tr>
        )
    }
}
